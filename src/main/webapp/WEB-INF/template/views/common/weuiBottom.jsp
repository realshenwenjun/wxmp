...
<div class="weui-tabbar" id="bottomTip">
    <a href="<%=path%>/gather/index/index.html" class="weui-tabbar__item weui-bar__item--on" tab="1">
    ...
    <a href="<%=path%>/gather/index/index.html" class="weui-tabbar__item" tab="2">
        <div class="weui-tabbar__icon">
            <img src="<%=path%>/res/js/plugins/jqueryweiui/images/icon_nav_msg.png" alt="">
        </div>
        <p class="weui-tabbar__label">通讯录</p>
    </a>
    <a href="<%=path%>/gather/index/index.html" class="weui-tabbar__item" tab="3">
        <div class="weui-tabbar__icon">
            <img src="<%=path%>/res/js/plugins/jqueryweiui/images/icon_nav_article.png" alt="">
        </div>
        <p class="weui-tabbar__label">发现</p>
    </a>
    <a href="<%=path%>/gather/index/index.html" class="weui-tabbar__item" tab="4">
        <div class="weui-tabbar__icon">
